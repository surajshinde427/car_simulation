...
- Add cars with names, positions, and commands
- Run the simulation
- View car results or restart/exit


# Running Test Cases
Test File: test_simulation.py
...
- Valid directions: N (North), E (East), S (South), W (West)
- Valid commands: L (Turn Left), R (Turn Right), F (Move Forward)
- The simulation detects collisions, including cross-path collisions.
